        ...
        <section className="bg-[#030303] pt-24 md:pt-[400px] pb-luxury-section px-8 md:px-12">
            <FadeIn padding={false}>
                <div className="relative w-full rounded-luxury-container bg-gradient-to-br from-[#0e0e0e] to-[#010101] border border-white/[0.06] overflow-hidden px-8 py-20 md:px-12 md:py-40 md:p-64 shadow-[0_120px_240px_rgba(0,0,0,1)] hover:border-luxury-accent/20 transition-all duration-1000 group/panel">
                    ...
                    <div className="absolute top-0 inset-x-0 h-[250px] bg-gradient-to-b from-white/[0.02] to-transparent z-10 pointer-events-none" />

                    {/* Layered Cinematic Wash - Custom Tone */}
                    <div className="absolute top-[-25%] right-[-15%] w-[1400px] h-[1400px] bg-white/[0.02] blur-[240px] rounded-full pointer-events-none z-0 group-hover/panel:bg-white/[0.04] transition-colors duration-1000" />
                    ...
                    <div className="relative z-10 max-w-5xl">
                        ...
                        <FadeIn direction="up" delay={0.4}>
                            <div className="flex flex-wrap gap-12 items-center">
                                <button className="group relative rounded-luxury-button bg-white text-black px-10 py-5 md:px-20 md:py-9 text-[15px] md:text-[17px] font-bold uppercase tracking-wider transition-all duration-700 hover:scale-[1.04] hover:shadow-[0_45px_90px_rgba(0,0,0,0.4)] hover:bg-white hover:text-black">
                                    <span className="relative z-10">Start The Aura</span>
                                    <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity" />
                                </button>
                                <button className="text-[16px] md:text-[18px] font-medium text-white/40 hover:text-white/80 group flex items-center gap-4 md:gap-8 transition-all duration-500">
                                    <span className="border-b border-white/10 group-hover:border-white/30">Explore Services</span>
                                    <span className="w-12 h-px md:w-16 md:h-px bg-white/20 transition-all duration-700 group-hover:w-24 group-hover:bg-white/40 shadow-none" />
                                </button>
                            </div>
                        </FadeIn>
                    </div>
